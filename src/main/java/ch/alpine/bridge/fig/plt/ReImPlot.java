    ...
    if (optional.isPresent()) {
      ...
      if (Sign.isPositive(x_clip.width())) { // TODO this should not checking here!
        ...
        pathIm.reset();
        {
          ...
          pathRe.moveTo(x0, showableConfig.confY.x_pos(reIm.re()));
          pathIm.moveTo(x0, showableConfig.confY.x_pos(reIm.im()));
        }
        ...
        for (int i = 1; i <= size; ++i) {
          ...
          pathRe.lineTo(xc, showableConfig.confY.x_pos(reIm.re()));
          pathIm.lineTo(xc, showableConfig.confY.x_pos(reIm.im()));
        }
        ...
        if (isFilling()) {
          {
            double y1 = showableConfig.confY.x_pos(suo.apply(x_clip.max()).zero());
            pathRe.lineTo(x1, y1);
            pathIm.lineTo(x1, y1);
          }
          {
            double y0 = showableConfig.confY.x_pos(suo.apply(x_clip.min()).zero());
            pathRe.lineTo(x0, y0);
            pathIm.lineTo(x0, y0);
          }
