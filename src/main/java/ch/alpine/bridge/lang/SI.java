...
public enum SI {
  ...
  public static final UnitHub PER_MINUTE = UnitHub.si("min^-1");
  public static final UnitHub SECONDS = UnitHub.si("s");
  public static final UnitHub PER_SECOND = UnitHub.si("s^-1");
}
