...
class V011ParamTest {
  ...
  void testFromString() throws IOException {
    ...
    String string = ObjectProperties.string(v011Param1);
    V011Param v011Param2 = new V011Param(2);
    ObjectProperties.fromString(v011Param2, string);
    // TODO BRIDGE
    // System.out.println(v011Param2.anotherParam.file);
    // System.out.println(v011Param2.string);
